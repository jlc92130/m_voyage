                ...
                <div class="flex-viewport" style="overflow: hidden; position: relative;">
                  <ul class="slides" style="width: 2400%; transition-duration: 1s; transform: translate3d(0px, 0px, 0px);">
                    ...
                    <li onclick="location.href='#';" style="width: 240.4px; float: left; display: block;">
                        <?php the_post_thumbnail() ?>  <!-- recupere les images -->
                        <div class="caption-info">
                         <div class="caption-info-head">
                          <div class="caption-info-head-left">
                            <h4><a href="<?php the_permalink(); ?>" title="<?php the_title_attribute(); ?>"><?php the_title(); ?></a></h4>  <!--recupere le titre -->
                              <span><?php the_excerpt(); ?></span>   <!-- recupere le contenu -->
                          </div>
...
<body>
  ...
  <div class="holiday-types">
      ...
      <?php   // Display Picture CPT
    			$argsPicture = array('post_type' => 'picture', 'posts_per_page' => '24');
    			$pictureQuery = new WP_Query($argsPicture);
    		?>
    		<?php if ( $pictureQuery->have_posts() ) : while ( $pictureQuery->have_posts() ) : $pictureQuery->the_post() ;?>
            <img class="menu_pictures" src="<?php the_post_thumbnail_url() ?>" alt="<?php the_title_attribute(); ?>">
